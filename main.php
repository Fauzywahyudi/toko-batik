...
<body>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <!-- <a class="navbar-brand" href="?page=home">
                    <span class="text-primary" style="font-weight: bold; font-size: 30px; font-family: 'Courier New', Courier, monospace; background-color: white; padding: 5px 30px; border-top-left-radius: 20px; border-bottom-right-radius: 20px">EFI</span> -->
                </a>
            </div>
    ...
    <!-- Footer -->
    <footer style="margin-bottom:0; background-color: #a53c35;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
