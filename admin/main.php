...
<body class="no-skin">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="index.html" class="navbar-brand">
					<!-- <span class="text-primary" style="font-weight: bold; font-size: 25px; font-family: 'Courier New', Courier, monospace; background-color: white; padding: 5px 30px; border-top-left-radius: 20px; border-bottom-right-radius: 20px">EFI</span> -->
				</a>
	...
	<div class="main-container" id="main-container">
		...
		<footer style="margin-top:200px; background-color: #a53c35;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p>Copyright &copy; 2021 - <a href="#">Skripsi IF Suriana Dewi</a></p>
					</div>
				</div>
			</div>
		</footer>
